  ...
  return (
    <Box sx={{ display: 'flex', zIndex: 120 }}>
      ...
      <Drawer variant="permanent" open={open}>
        <DrawerHeader>
          <IconButton onClick={handleDrawerClose}>
            {themeHook.direction === 'rtl' ? <ChevronRightIcon /> : <ChevronLeftIcon />}
          </IconButton>
        </DrawerHeader>
        <Divider />
      ...
      <Box component="main" sx={{ flexGrow: 1 }}>
        ...
        {!loading && !error && <div>
          {selectedPanel === 'Map' && <MapComponent features={lightning?.features as Feature[]}/>}
          {selectedPanel === 'Table' && <TableComponent lightning={lightning?.features as Feature[]}/>}
